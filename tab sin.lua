...
local function createGui()
	...
	bringLabel.Position = UDim2.new(0, 30, 0, 40)
	...
	stopBox.Position = UDim2.new(0, 350, 0, 90)
	stopBox.Size = UDim2.new(0, 100, 0, 30)
	stopBox.Text = ""

	local playerLabel = Instance.new("TextLabel", frame)
	playerLabel.Position = UDim2.new(0, 30, 0, 140)
	playerLabel.Size = UDim2.new(0, 300, 0, 30)
	playerLabel.Text = "Tên người chơi (mặc định là bạn)"
	playerLabel.TextColor3 = Color3.new(1, 1, 1)
	playerLabel.BackgroundTransparency = 1

	local playerBox = Instance.new("TextBox", frame)
	playerBox.Position = UDim2.new(0, 350, 0, 140)
	playerBox.Size = UDim2.new(0, 100, 0, 30)
	playerBox.Text = ""

	local bringBtn = Instance.new("TextButton", frame)
	bringBtn.Position = UDim2.new(0, 30, 0, 200)
	bringBtn.Size = UDim2.new(0, 200, 0, 40)
	bringBtn.Text = "Bring"
	...
	stopBtn.Position = UDim2.new(0, 300, 0, 200)
