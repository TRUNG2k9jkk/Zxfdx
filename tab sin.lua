...
-- Nhãn + Ô nhập Bring Distance
local bringLabel = Instance.new("TextLabel", frame)
bringLabel.Position = UDim2.new(0, 20, 0, 20)
bringLabel.Size = UDim2.new(0, 200, 0, 25)
bringLabel.Text = "Khoảng cách Bring (mặc định 100)"
bringLabel.TextColor3 = Color3.new(1,1,1)
bringLabel.BackgroundTransparency = 1
bringLabel.TextScaled = true

local bringBox = Instance.new("TextBox", frame)
bringBox.Position = UDim2.new(0, 230, 0, 20)
bringBox.Size = UDim2.new(0, 140, 0, 25)
bringBox.Text = ""

-- Nhãn + Ô nhập Stop Speed
local stopLabel = Instance.new("TextLabel", frame)
stopLabel.Position = UDim2.new(0, 20, 0, 60)
stopLabel.Size = UDim2.new(0, 200, 0, 25)
stopLabel.Text = "Tốc độ Stop (mặc định 0)"
stopLabel.TextColor3 = Color3.new(1,1,1)
stopLabel.BackgroundTransparency = 1
stopLabel.TextScaled = true

local stopBox = Instance.new("TextBox", frame)
stopBox.Position = UDim2.new(0, 230, 0, 60)
stopBox.Size = UDim2.new(0, 140, 0, 25)
stopBox.Text = ""

-- Nút Bring
local bringBtn = Instance.new("TextButton", frame)
bringBtn.Position = UDim2.new(0, 40, 0, 120)
bringBtn.Size = UDim2.new(0, 140, 0, 35)
bringBtn.Text = "Bring"
...
stopBtn.Size = UDim2.new(0, 140, 0, 35)
stopBtn.Text = "Stop"
...
-- Bring mob
local function bringMobs(distance)
		...
		if mob:IsA("Model") and mob:FindFirstChildOfClass("Humanoid") and mob:FindFirstChild("HumanoidRootPart") then
			if not isPlayer(mob) then
				...
				if dist <= distance then
					...
					local goal = hrp.CFrame * CFrame.new(offset)
...
bringBtn.MouseButton1Click:Connect(function()
	local dist = tonumber(bringBox.Text)
	bringMobs(dist or DEFAULT_BRING_DISTANCE)
end)

stopBtn.MouseButton1Click:Connect(function()
	local spd = tonumber(stopBox.Text)
	stopMobs(spd or DEFAULT_STOP_SPEED)
end)
end)
