...
local function createGui()
	if player:FindFirstChild("PlayerGui"):FindFirstChild("BringStopUI") then
		player.PlayerGui:FindFirstChild("BringStopUI"):Destroy()
	end
	...
	bringLabel.Position = UDim2.new(0, 20, 0, 40)
	bringLabel.Size = UDim2.new(0, 300, 0, 30)
	...
	bringBox.Position = UDim2.new(0, 20, 0, 70)
	bringBox.Size = UDim2.new(0, 100, 0, 30)
	bringBox.Text = ""

	local stopLabel = Instance.new("TextLabel", frame)
	stopLabel.Position = UDim2.new(0, 20, 0, 120)
	stopLabel.Size = UDim2.new(0, 300, 0, 30)
	stopLabel.Text = "Tốc độ sau Stop (mặc định: 0)"
	stopLabel.TextColor3 = Color3.new(1, 1, 1)
	stopLabel.BackgroundTransparency = 1

	local stopBox = Instance.new("TextBox", frame)
	stopBox.Position = UDim2.new(0, 20, 0, 150)
	stopBox.Size = UDim2.new(0, 100, 0, 30)
	stopBox.Text = ""

	local bringBtn = Instance.new("TextButton", frame)
	bringBtn.Position = UDim2.new(0, 20, 0, 200)
	...
	stopBtn.Position = UDim2.new(0, 200, 0, 200)
	...
	bringBtn.MouseButton1Click:Connect(function()
		local val = tonumber(bringBox.Text)
		bringMobs(val or DEFAULT_BRING_DISTANCE)
	end)

	stopBtn.MouseButton1Click:Connect(function()
		local val = tonumber(stopBox.Text)
		stopMobs(val or DEFAULT_STOP_SPEED)
	end)
end

-- Khởi động GUI ban đầu
createGui()

-- Tạo lại GUI khi nhân vật respawn
